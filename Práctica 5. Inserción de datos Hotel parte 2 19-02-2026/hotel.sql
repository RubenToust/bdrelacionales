...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 16:17:32
...
(1, 1, 7, '2026-02-21', 'Buena atención, servicio rápid'),
(2, 3, 4, '2026-02-18', 'Me dió un buen trato y fue muy'),
(3, 4, 3, '2026-04-07', 'Dejó muy limpio el cuarto, per'),
(4, 5, 2, '2025-10-12', 'Tardó mucho en llegar, andaba '),
(5, 9, 1, '2026-02-09', 'Me resolvió los inconvenientes');
...
(1, 1, '2026-02-18', 15000, 'Tarjeta', '250290248210', 'Acreditado'),
(2, 3, '2026-02-06', 12300, 'Tarjeta', '2149084003', 'Completo'),
(3, 4, '2026-02-17', 10000, 'Transferencia', '2241980400312', 'En Proceso'),
(4, 5, '2025-10-08', 5400, 'Efectivo', '12324523858', 'Acreditado'),
(5, 7, '2026-02-05', 44500, 'Efectivo', '14135467534', 'Acreditado');
...
(1, 'Lavado de ropa', 200),
(2, 'Servicio de Comida', 500),
(3, 'Gimnasio', 80),
(4, 'Spa', 120),
(5, 'Valet Parking', 50);
...
--
ALTER TABLE `atencion`
  ADD CONSTRAINT `antecion_ibfk_1` FOREIGN KEY (`id_empleado`) REFERENCES `empleado` (`id_empleado`),
...
ALTER TABLE `reserva_servicio`
  ...
  ADD CONSTRAINT `reserva_servicio_ibfk_2` FOREIGN KEY (`id_reserva`) REFERENCES `reserva` (`id_reserva`);
COMMIT;
